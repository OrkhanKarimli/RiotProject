...
namespace Riod.WebUI.Areas.Admin.Controllers
{
    ...
    public class Brands : Controller
    {
        ...
        public  Brands(RiodeDbContext db)
        {
            this.db = db;
        }
        public async Task<IActionResult> Index()
        {
            ...
            vdt.Brands = await db.Brands.Where(b => b.DeletedByUserId == null).ToListAsync();
            return View(vdt);
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create(NBrand bd)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> Edit([FromRoute]int id,NBrand bd)
        {
            if (!ModelState.IsValid)
            {
              return View(bd);
